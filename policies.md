...
**Grading.** The final course grade is based on the homework assignments (65% total) and exams (20% midterm; 15% final).

Homework assignments will consist of writing Python code to solve problems as well as written questions. **Submissions must be Jupyter notebooks, which let you combine formatted text and Python code in an easy-to-use format.**
...
If you believe there is an error in grading (homeworks or exams), you may request a regrading within **three working days** receiving your grade. Requests must be made in writing by email to instructor, explaining clearly why you think there was an error in your grade.
...
forums, or finding answers to specific questions from the internet, or using AI tools (such as ChatGPT) to generate answers is not
allowed and is considered cheating.

There must be no collaboration on exams, or quizzs if available.
...
**Addendum (01/12/2026): Late Penalty Waivers.**
